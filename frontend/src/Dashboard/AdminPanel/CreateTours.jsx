        ...
        <div className="flex flex-col justify-center">
          <div className="text-center mb-6">
            ...
            <p className="text-sm md:text-base text-GrayColor">
              Create a new tour by filling all fields.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-2 md:space-y-3">
            ...
            <div className="md:grid grid-cols-3 gap-8">
              ...
              <div>
                <label htmlFor="maxGroupSize" className="block text-md md:text-lg font-medium text-GrayColor">Max People</label>
                <input
                  type="number"
                  name="maxGroupSize"
            ...
            <div>
              <label htmlFor="photo" className="block text-md md:text-lg font-medium text-GrayColor">Photo URL</label>
              <input
                type="text"
                name="photo"
